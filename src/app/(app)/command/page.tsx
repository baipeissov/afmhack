    ...
    <div className="flex h-full">
      <div className="min-w-0 flex-1 space-y-5 overflow-y-auto p-6">
        <PageIntro
          ...
          lead="SwarmShield automatically finds fraudulent videos on social media and runs AI investigations against them. Here's everything happening across your organization right now."
          right={
        ...
        <div className="grid grid-cols-1 gap-4 xl:grid-cols-[1.6fr_1fr]">
          <Card>
            <CardHeader>
              <CardTitle>Risk inflow · last 72h</CardTitle>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Scheme mix</CardTitle>
            </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <span className="text-[11px] text-text-muted">highest risk first</span>
          </CardHeader>
            ...
            {queue.map((c) => (
              ...
              >
                ...
                <span className="flex items-center gap-1.5 text-xs text-text-secondary">
                  ...
                  {c.agentsDone}/{c.agentsTotal} agents
                </span>
